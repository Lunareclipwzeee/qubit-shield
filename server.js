...
function requireSentinel(req,res,next){
  ...
  return res.status(403).json({ok:false,error:'QUBIT Sentinel requires Enterprise plan',upgrade:'mailto:pilotsqubitshield@gmail.com?subject=Upgrade to Enterprise'});
}
