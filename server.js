...
<body style="margin:0;padding:0;background-color:#020812;">
...
<tr><td bgcolor="#06b6d4" style="padding:24px 40px;">
...
<tr><td bgcolor="#020812" style="padding:40px;">
<p style="font-size:15px;color:#f0f6ff;margin:0 0 16px;font-family:Arial;">Hi <strong style="color:#06b6d4;">${name}</strong>,</p>
<p style="font-size:13px;color:#94a3b8;margin:0 0 32px;font-family:Arial;line-height:1.6;">Your 30-day free pilot for <strong style="color:#f0f6ff;">${company}</strong> is now active.</p>
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#0a1628" style="border:1px solid #06b6d4;margin-bottom:32px;">
<tr><td style="padding:24px;">
<p style="font-size:9px;color:#64748b;margin:0 0 12px;text-transform:uppercase;letter-spacing:3px;font-family:Arial;">Your API Key</p>
<p style="font-family:Courier New,monospace;font-size:15px;color:#06b6d4;margin:0;word-break:break-all;">${apiKey}</p>
</td></tr>
</table>
<p style="font-size:12px;color:#f0f6ff;margin:0 0 16px;font-family:Arial;font-weight:bold;text-transform:uppercase;letter-spacing:1px;">Next Steps</p>
<p style="font-size:13px;color:#94a3b8;margin:0 0 8px;font-family:Arial;">1. Save your API key above</p>
<p style="font-size:13px;color:#94a3b8;margin:0 0 8px;font-family:Arial;">2. Visit eigenlock.in/dashboard and enter your API key</p>
<p style="font-size:13px;color:#94a3b8;margin:0 0 32px;font-family:Arial;">3. Reply to this email for integration support</p>
...
<tr><td bgcolor="#060f1e" style="padding:20px 40px;text-align:center;border-top:1px solid #0a1628;">
...
<p style="font-size:11px;color:#475569;margin:8px 0 0;font-family:Arial;">© 2026 EIGENLOCK · A LUNARECLIPSE Technology</p>
</td></tr>
</table>
</td></tr>
</table>
